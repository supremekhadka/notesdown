...
export default function NavBar(){
    ...
    return(
        <div className="navbar z-10 flex sm:justify-end justify-end w-full gap-16 h-[5rem] p-8 pr-12 sm:pr-16 pl-3">
            
            {pathname === '/notes' && (
                <Link className="sm:hidden flex w-max" href='/'>
                    <svg fill="#FFF" version="1.1" id="Capa_1" width="auto" height="35px" style={{transform: 'scale(-1, 1)'}} viewBox="0 0 400.943 400.943">
                        <g>
