...
export default function NotesPage() {
  ...
  return (
    <div
      className={`z-10 min-h-full sm:min-h-full h-auto flex flex-col items-center`}
    >
      <h1 className="text-[1.7em] sm:mt-2 sm:static absolute top-10 font-semibold">
        Notes
      </h1>
          ...
          <div className=" p-8 rounded-md">
            ...
            >
              ...
              <button type="submit" className="SaveBtn mt-16">
                Save
                <svg
                  className="Savesvg svg bi bi-save2-fill"
      ...
      <div className="flex flex-wrap justify-center mt-5">
        {[...notes].reverse().map((note, index) => (
          ...
          >
            <div
              className={`${gochiHand.className} text-xl max-w-[50vw] text-ellipsis overflow-hidden mb-5`}
            >
              {note}
            </div>
            <div className="mt-2 flex gap-4 justify-center bottom-5">
              <button
                onClick={() => handleEditNote(notes.length - 1 - index)}
                className="Btn"
              >
                Edit
              ...
              >
                ...
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi Dltsvg bi-trash-fill"
                  viewBox="0 0 16 16"
                >
                  {" "}
